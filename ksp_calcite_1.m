...
function kspc = ksp_calcite_1(T,S)

% x is ALK and y is CO2
% -------------------------------------------------------------------------
% some constants
% -------------------------------------------------------------------------
  B_T = 1;                     % total boron [umol/kg]  % ROCCO EDIT (changed this from 400 to 0)
  T   = T;                      % bottom water temp [degC] % ROCCO EDIT (made this an input from the function)
  T_K = T + 273.15;              % converted temp [K]
  P   = 1;                     % pressure at depth [atm] % ROCCO EDIT (changed this to 1)
  S   = S;                      % salinity [ppt] % ROCCO EDIT (made this an input from the function)
